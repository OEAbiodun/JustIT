...
logging.basicConfig(filename = r"Week 10\Completed code\Pt8_Exceptions_CollectionsCodeBase\1_Exceptions/file1.log", level = logging.DEBUG) # to see all error logs
