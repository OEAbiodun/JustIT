...
filePath1 = open('C:/Users/oeabi/Desktop/python 3/Week 10/test1.txt', 'w') # folder/folder/filename
# write to file
# filePath1.write("My name is Oluwaseun Emmanuel Abiodun")
filePath1.write("\nI live in London.")
filePath1.write("\nI now live in Stansted")
